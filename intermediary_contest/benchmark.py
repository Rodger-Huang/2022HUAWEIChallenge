...
if __name__ == '__main__':
    #读取输入文件
    configFile = 'intermediary_contest/data/config.ini'
    demandFile = 'intermediary_contest/data/demand.csv'
    site_bandwidthFile = 'intermediary_contest/data/site_bandwidth.csv'
    solutionFile = 'intermediary_contest/output/solution.txt'
    qosFile = 'intermediary_contest/data/qos.csv'
